...
- **[Multi-Agent Workflows](workflows.md)** — Python-based multi-agent pipelines with checkpointed phases, parallel execution, and structured data flow. Survive interrupts, resume mid-flight, and enforce JSON schemas between phases.
